...
export const CreateCompliance = (props) => {
  ...
  const createDoable = (e) => {
    ...
    // })
    const obj = {};
    obj['reminderPeriod'] = reminderPeriod;
        ...
        loadingCreate
          ...
          <div style={{ boxShadow: '0px 3px 6px 4px #bbb', margin: '10px 0px' }}>
            <div style={{ justifyContent: 'space-between', background: '#49c9ba', color: 'white', padding: '10px', display: 'flex' }}>
              ...
              <div><CloseButton variant='white' onClick={(e) => props.handleClose(e)} /></div>
            </div>
            <div style={{ padding: '20px' }}>
              ...
              <div style={{ marginTop: '10px' }}>
                ...
                <Button onClick={createDoable} style={{ backgroundColor: "rgb(52 214 214)", border: 'none', marginLeft: '20px' }}>
                  Save Changes
                </Button>
              </div>
            </div>
